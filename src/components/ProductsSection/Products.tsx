        ...
        <div className="overflow-hidden bg-white rounded shadow">
          <div className="p-5 ">
            ...
            <div>
              ...
              <p className="mt-4 text-base text-gray-600  text-justify lg:text-left">
                Es una invitación a reflexionar sobre el año pasado para recibir
                el nuevo con mayor conciencia. Las cartas sirven como
      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex items-end justify-between">
          <div className="flex-1 text-center lg:text-left">
            ...
            text-lg leading-relaxed text-gray-600 lg:mx-0"
            >
