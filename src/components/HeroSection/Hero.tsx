        ...
        <div className="container py-16 lg:py-20">
          <div className="grid lg:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div className="flex flex-col">
              ...
              <h1 className="scroll-m-20 text-5xl font-extrabold tracking-tight lg:text-6xl text-center lg:text-start">
                <span className="text-purple-800">No </span> somos un regalo
                corporativo
              </h1>
              <p className="mt-4 text-lg text-muted-foreground text-center lg:text-start max-w-3xl mx-auto">
